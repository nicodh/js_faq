...
return array(
	'ctrl' => array(
		...
		'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('js_faq') . 'Resources/Public/Icons/tx_jsfaq_domain_model_expert.gif'
	),
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_jsfaq_domain_model_expert.pid=###CURRENT_PID### AND tx_jsfaq_domain_model_expert.sys_language_uid IN (-1,0)',
			),
		),
		...
		'email' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:js_faq/Resources/Private/Language/locallang_db.xlf:tx_jsfaq_domain_model_expert.email',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
		...
		'url' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:js_faq/Resources/Private/Language/locallang_db.xlf:tx_jsfaq_domain_model_expert.url',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
